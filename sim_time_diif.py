...
env.process(packet_gen(env , res, param[0], param[1], param[2],0))
env.process(packet_gen(env , res, param[0], param[1], param[3],1))
env.process(packet_gen(env , res, param[0], param[1], param[4],2))
